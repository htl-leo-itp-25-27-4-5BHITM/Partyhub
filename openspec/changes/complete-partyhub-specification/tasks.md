...
- [x] 5.4 Complete the invitation/attendance specification update and handoff; verify accepted rules are integrated, edge-case decisions are linked, and source gaps remain separate from normative scenarios.
