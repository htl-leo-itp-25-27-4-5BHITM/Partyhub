...
**Party invitations and attendance.** [src/main/java/at/htl/party/PartyRepository.java](../../src/main/java/at/htl/party/PartyRepository.java); [src/main/java/at/htl/party/PartyResource.java](../../src/main/java/at/htl/party/PartyResource.java); [src/main/java/at/htl/invitation/InvitationRepository.java](../../src/main/java/at/htl/invitation/InvitationRepository.java); [src/main/java/at/htl/invitation/InvitationResource.java](../../src/main/java/at/htl/invitation/InvitationResource.java); [src/main/resources/META-INF/resources/addParty/addParty.js](../../src/main/resources/META-INF/resources/addParty/addParty.js); [src/main/resources/META-INF/resources/advancedPartyInfos/advancedPartyInfos.js](../../src/main/resources/META-INF/resources/advancedPartyInfos/advancedPartyInfos.js); [src/main/resources/META-INF/resources/notifications/notifications.js](../../src/main/resources/META-INF/resources/notifications/notifications.js); [PartyHubiOS/PartyHubiOS/Map/InvitationsView.swift](../../PartyHubiOS/PartyHubiOS/Map/InvitationsView.swift); [PartyHubiOS/PartyHubiOS/Map/InvitationsViewModel.swift](../../PartyHubiOS/PartyHubiOS/Map/InvitationsViewModel.swift); [PartyHubiOS/PartyHubiOS/PartyView/InviteUsersView.swift](../../PartyHubiOS/PartyHubiOS/PartyView/InviteUsersView.swift); [PartyHubiOS/PartyHubiOS/PartyView/PartyDetailView.swift](../../PartyHubiOS/PartyHubiOS/PartyView/PartyDetailView.swift); [src/test/java/at/htl/repository/InvitationRepositoryTest.java](../../src/test/java/at/htl/repository/InvitationRepositoryTest.java); [src/test/java/at/htl/resource/InvitationResourceTest.java](../../src/test/java/at/htl/resource/InvitationResourceTest.java); [src/test/java/at/htl/repository/PartyRepositoryTest.java](../../src/test/java/at/htl/repository/PartyRepositoryTest.java); [src/test/java/at/htl/resource/PartyResourceTest.java](../../src/test/java/at/htl/resource/PartyResourceTest.java); [api/invitation.http](../../api/invitation.http); [api/party.http](../../api/party.http).

Observed: `inviteSelectedUsersForPrivateParty` creates/renews invitations but does not remove deselected rows or check mutual follows. Direct invitation creation lacks stored-host/mutual-contact checks. Join accepts any authenticated user into an existing private party, marks an existing invitation accepted, and treats duplicate membership as a no-op; leave removes membership, declines an existing invitation and reports an absent repeat as missing. Invitation detail/list access is sender/recipient-relative, while invited-member/statistics projections are available to every authenticated party viewer, join status omits visibility, and statistics count the host as accepted. Browser selection computes a mutual-contact intersection but cannot enforce it server-side. iOS list/create models and payload names differ from backend DTOs. See [invitations-and-attendance.md](invitations-and-attendance.md) and G009/G017/G031-G033.

Test evidence: Invitation repository/resource tests assert basic creation, list/detail status, sender deletion, recipient decline, declined renewal and some notification counts. Party tests cover selected-user creation, private-update invitation creation, joined-member projection and basic stats/missing attendance responses. No inspected test establishes stored-host management, self/non-mutual denial, private join denial, join/leave atomicity, retry event deduplication, host-only projections, correct host-free statistics or cross-client schema compatibility. None was run.
